              ...
              {isMobile ? (
                <div className="relative h-full w-full max-w-[70%] md:max-w-[80%]">
                  {screenshots[1] ? (
                    <div className="absolute -bottom-16 left-0 z-10 w-[38%] origin-bottom md:-bottom-24 md:left-4">
                      <div className="relative aspect-9/19 overflow-hidden rounded-t-2xl border-x-2 border-t-2 border-neutral-800 bg-black shadow-2xl transition-transform duration-500 group-hover:scale-105 md:rounded-t-3xl md:border-x-4 md:border-t-4">
                        <Image
                          src={screenshots[1]}
                          alt="Screen 2"
                          fill
                  ...
                  <div className="absolute -bottom-16 left-1/2 z-20 w-[48%] -translate-x-1/2 origin-bottom md:-bottom-24">
                    <div className="relative aspect-9/19 overflow-hidden rounded-t-2xl border-x-4 border-t-4 border-neutral-900 bg-neutral-900 shadow-2xl ring-1 ring-white/10 transition-transform duration-500 group-hover:scale-105 md:rounded-t-3xl md:border-x-6 md:border-t-6">
                ...
                <div className="absolute -bottom-2 w-[80%] origin-bottom md:w-[85%]">
                  <div className="relative flex aspect-16/10 flex-col overflow-hidden rounded-t-lg border-x border-t border-white/10 bg-neutral-900 shadow-2xl md:rounded-t-xl">
                    ...
                    <div className="relative flex-1 bg-neutral-900 transition-transform duration-500 group-hover:scale-105">
                      {screenshots[0] ? (
                        <Image
                          src={screenshots[0]}
                          alt="App screenshot"
