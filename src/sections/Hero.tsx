      ...
      <div className="grid w-full items-end gap-10 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="space-y-6">
          ...
          <h1 className="max-w-3xl text-4xl font-bold leading-tight sm:text-6xl lg:text-7xl">
            Daryl D. Bacusmo.
            <br />
            <span className="text-gradient-shimmer">Engineering the future.</span>
          </h1>
          <p className="max-w-2xl text-base text-(--muted) sm:text-lg">
            Motivated Computer Engineering student with foundational knowledge in networking, operating systems, system troubleshooting, and cloud technology concepts.
          </p>
        ...
        <div className="rounded-2xl border border-(--card-border) bg-linear-to-br from-(--card) to-(--card-border) p-6">
          ...
          <ul className="space-y-2 text-sm text-(--muted)">
            ...
            <li>- Cloud Technology Concepts</li>
          </ul>
          <div className="mt-5 grid grid-cols-3 gap-2 border-t border-white/10 pt-4 text-center">
            ...
            <div>
              <p className="text-lg font-bold text-(--foreground)">Cebu</p>
              <p className="text-[10px] uppercase tracking-wider text-(--muted)">Location</p>
            </div>
            <div>
              <p className="text-lg font-bold text-(--foreground)">2026</p>
              <p className="text-[10px] uppercase tracking-wider text-(--muted)">Expected</p>
            </div>
          </div>
        </div>
      </div>
