  ...
  const items = [
    {
      ...
      icon: Trophy,
      title: "Interests",
      desc: "Cloud-native application development, scalable distributed systems, and open-source contribution.",
      href: "#other",
    ...
    },
    {
      ...
      icon: BookOpen,
      title: "Languages",
      desc: "English (Professional) and Filipino (Native).",
      href: "#other",
    ...
    },
    {
      ...
      icon: Link2,
      title: "Learning",
      desc: "Self-directed learning in Linux administration, cloud fundamentals (AWS/GCP), and Java.",
      href: "#other",
